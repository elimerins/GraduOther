...
public class AsyncMessageReader implements CompletionHandler<Integer, Void>, MessageReader<XMessageHeader, XMessage> {
     ...
     * Parse a message.
     *
     * @param messageClass class extending {@link GeneratedMessage}
     ...
     *
     * @param messageClass class extending {@link GeneratedMessage}
     * @param message      {@link GeneratedMessage}
     */
     ...
     *
     * @param reuse {@link Message} object to reuse
     * @param hdr   {@link MessageHeader} object
     * @return
     * @throws IOException
     * @throws CJCommunicationsException wrapping an {@link IOException} during read or parse
     * @throws XProtocolError            if an <i>Error</i> message is received from the server
     */
    @Override
